...
void oled_print_channel(uint8_t, uint8_t);
void oled_print_arrow(uint8_t);
void oled_clear_arrows();
void oled_print_output1(uint8_t);
void oled_print_output2(uint8_t);
void oled_print_output3(uint8_t);
